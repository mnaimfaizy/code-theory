...
Sync note: if you update this reference, make the same change in the mirrored copies under `.claude/skills/ingestion-generation/references/` and `.agents/skills/ingestion-generation/references/`.
