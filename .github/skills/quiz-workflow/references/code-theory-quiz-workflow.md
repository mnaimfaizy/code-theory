...
Sync note: if you update this reference, make the same change in the mirrored copies under `.claude/skills/quiz-workflow/references/` and `.agents/skills/quiz-workflow/references/`.
