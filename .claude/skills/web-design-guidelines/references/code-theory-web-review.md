...
Sync note: if you update this reference, make the same change in the mirrored copies under `.github/skills/web-design-guidelines/references/` and `.agents/skills/web-design-guidelines/references/`.
