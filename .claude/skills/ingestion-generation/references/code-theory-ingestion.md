...
Sync note: if you update this reference, make the same change in the mirrored copies under `.github/skills/ingestion-generation/references/` and `.agents/skills/ingestion-generation/references/`.
