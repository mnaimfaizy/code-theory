...
Sync note: if you update this reference, make the same change in the mirrored copies under `.github/skills/tailwind-design-system/references/` and `.agents/skills/tailwind-design-system/references/`.
