...
Sync note: if you update this reference, make the same change in the mirrored copies under `.github/skills/drizzle-database/references/` and `.agents/skills/drizzle-database/references/`.
