...
export const certifications = sqliteTable("certifications", {
  ...
  timeLimitMinutes: integer("time_limit_minutes"), // null = untimed available
...
export const questionSources = sqliteTable("question_sources", {
  ...
  sourceRef: text("source_ref").notNull(), // URL or filename
...
export const duplicateFlags = sqliteTable("duplicate_flags", {
  ...
  similarity: integer("similarity"), // 0-100 percentage
