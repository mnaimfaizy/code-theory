...
Sync note: if you update this reference, make the same change in the mirrored copies under `.github/skills/shadcn/references/` and `.claude/skills/shadcn/references/`.
