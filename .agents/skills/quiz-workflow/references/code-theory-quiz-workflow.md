...
Sync note: if you update this reference, make the same change in the mirrored copies under `.github/skills/quiz-workflow/references/` and `.claude/skills/quiz-workflow/references/`.
