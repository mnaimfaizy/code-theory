...
Sync note: if you update this reference, make the same change in the mirrored copies under `.github/skills/frontend-design/references/` and `.claude/skills/frontend-design/references/`.
